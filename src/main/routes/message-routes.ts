...
import { makeRemoveMessageController } from '@main/factories/message/remove-message-controller-repository';
...
export default (router: Router): void => {
  ...
  router.delete('/message/:messageId', auth, adaptRoute(makeRemoveMessageController()));
};
